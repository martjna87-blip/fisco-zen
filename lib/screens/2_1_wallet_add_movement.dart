...
class _AddMovementSheetState extends State<AddMovementSheet> {
  ...
  int? _categoriaEspansaIndex; // Per le freccette accordion nel riepilogo
  ...
  DateTime _dataSelezionata = DateTime.now(); // Data movimento corrente
  DateTime _meseSelezionatoRiepilogo = DateTime.now();

  // LISTA DELLE SOTTOCATEGORIE DETTAGLIATE
  ...
  // LISTA DINAMICA REALE DEI MOVIMENTI (Vuota per simulazione da zero)
  final List<Map<String, dynamic>> _movimentiReali = [];

  // STATI ESPANSIONE IN-LINE
  ...
  // FORMATTAZIONE VALUTA CON PUNTO DELLE MIGLIAIA (es. 4.454,67 €)
  ...
  // SUGGERIMENTO AUTOMATICO CATEGORIA IN BASE AL TESTO
  ...
  // SALVATAGGIO REALE DEL MOVIMENTO NEL PROVIDER E RIEPILOGO
  void _salvaMovimento() {
    ...
    // 1. Mappatura Categoria per il Provider
    ...
    // 2. Mappatura Account per detrarre/accreditare dal conto corretto
    String? accountId;
    ...
    // 4. Salva anche nella lista del riepilogo locale
    setState(() {
      _movimentiReali.add({
        'desc': descrizione,
        'imp': importo,
    ...
    // 5. Chiudi il modale per vedere il Wallet aggiornato
    Navigator.pop(context);
  }

  // CALENDARIO COMPATTO ITALIANO
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                image: const DecorationImage(
                  image: NetworkImage('https://images.unsplash.com/photo-1517248135467-4c7edcad34c4?q=80&w=1000&auto=format&fit=crop'),
                  fit: BoxFit.cover,
                ),
              ),
              child: Container(
                decoration: BoxDecoration(
                  ...
                  gradient: LinearGradient(
                    ...
                    colors: [Colors.black.withOpacity(0.35), Colors.black.withOpacity(0.80)],
                  ),
                ),
              ),
            ),
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    // TAB SELETTORE A 3 VOCI: RIEPILOGO | SPESA | ENTRATA
                    Container(
                    ...
                    if (_tipoMovimento != 'riepilogo') ...[
                      const SizedBox(height: 10),
                      // PULSANTE SALVA MOVIMENTO REALE
                      SizedBox(
                        width: double.infinity,
                        height: 48,
                        child: ElevatedButton(
                          ...
                          child: const Text('Salva Movimento', style: TextStyle(fontSize: 15, fontWeight: FontWeight.bold)),
                        ),
                      ),
                    ],
                  ],
  ...
  // SCHERMATA RIEPILOGO DINAMICA CON FORMATTAZIONE VALUTA E COLORI
  Widget _buildSchermataRiepilogo() {
    // 1. Filtro movimenti del Mese e Anno selezionati
    ...
    // 2. Calcola i totali del mese selezionato (Spese ed Entrate)
    ...
    // 3. Raggruppamento dinamico PER CATEGORIA
    ...
    // 4. Raggruppamento dinamico PER DATA (Ordinamento Decrescente: più recente prima)
    ...
    return Column(
      children: [
        // TESTATA CON FRECCE MESE (← mese anno →) E RIEPILOGO TOTALE (ENTRATE / SPESE)
        Container(
              ...
              : _vistaRiepilogo == 'categoria'
                  ...
                  : ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        // BILANCIO NETTO GIORNALIERO CORRETTO (Entrate - Spese)
